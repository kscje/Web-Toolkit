...
var I18n = (function () {
  ...
  function resolveLanguage() {
    ...
    if (!stored && TextFlow.isChromeStorageAvailable()) {
      try {
        var data = JSON.parse(localStorage.getItem('textflow') || '{}');
